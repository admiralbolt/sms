  ...
  operations = [
        ...
        (
          ...
          models.CharField(
            choices=[
              ...
              ("Crawler - Blue Moon", "Crawler - Blue Moon"),
              ("Crawler - Darrell's Tavern", "Crawler - Darrell's Tavern"),
              ("Crawler - Little Red Hen", "Crawler - Little Red Hen"),
              ("Crawler - Sea Monster Lounge", "Crawler - Sea Monster Lounge"),
              ("Crawler - Skylark", "Crawler - Skylark"),
              ("Crawler - The Royal Room", "Crawler - The Royal Room"),
              ("Dice", "Dice"),
              ("Eventbrite", "Eventbrite"),
              ("Manual", "Manual"),
              ("Open Mic Generator", "Open Mic Generator"),
              ("Songkick", "Songkick"),
    ...
    migrations.CreateModel(
      ...
      fields=[
        ...
        (
          "event_mic_type",
          models.CharField(
            choices=[("Open Jam", "Open Jam"), ("Open Mic", "Open Mic"), ("Show", "Show")], default="Open Mic", max_length=32
          ),
        ),
        (
          "open_mic_type",
          models.CharField(
            choices=[("All", "All"), ("Comedy", "Comedy"), ("Music", "Music"), ("Spoken Word", "Spoken Word")],
            default="Music",
            max_length=16,
          ),
        ),
    ...
    migrations.CreateModel(
      ...
      fields=[
        ...
        (
          "event_type",
          models.CharField(choices=[("Open Jam", "Open Jam"), ("Open Mic", "Open Mic"), ("Show", "Show")], default="Show", max_length=16),
        ),
    ...
    migrations.CreateModel(
      ...
      fields=[
        ...
        (
          "field_changed",
          models.CharField(choices=[("event", "event"), ("venue", "venue"), ("artist", "artist"), ("none", "none")], max_length=32),
        ),
