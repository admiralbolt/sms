    ...
    <Box>
      <Box
       ...
       >
        ...
        />
        <Button sx={{marginLeft: "1em", height: "3em"}} variant="contained" onClick={createOpenMic}>Create New</Button>
      </Box>
      <Box width="100%" height="2em" />
      <Divider />
      {(selectedMic != undefined) &&
        <OpenMicCard openMic={selectedMic} isNew={isNew} deleteCallback={onDelete} createCallback={onCreate} />
      }
    </Box>
  );
};
