    ...
    <>
      ...
      >
        ...
        <List sx={{ listStyleType: "disc", pl: 4 }}>
          ...
          >
            Linted & prettified the frontend code (which only affects
            developers).
          </ListItem>
        </List>
        Open Mic/Jam Adjustments <br />
        ...
        <List sx={{ listStyleType: "disc", pl: 4 }}>
          ...
          >
            ...
            <List sx={{ listStyleType: "circle" }}>
              ...
              >
                Venues that have the same name but different latitude /
                longitude breaking the ingester.
              </ListItem>
            </List>
          </ListItem>
        </List>
        ...
        <List sx={{ listStyleType: "disc", pl: 4 }}>
          ...
          >
            Fixed a bug where some non music events (like trivia) were
            incorrectly showing up.
          </ListItem>
          <ListItem
            sx={{
              display: "list-item",
